...
// Simple `cn` function to merge class names
    ...
    <div className="flex items-center justify-center">
      {href ? (
        <a href={href} target="_blank" rel="noopener noreferrer">
          ...
          >
            <div className="border border-[#3B3A3A] bg-[#581a0e] h-[43px] rounded-full flex items-center justify-center text-white">
        ...
        >
          <div className="border border-[#3B3A3A] bg-[#241d17] h-[43px] rounded-full flex items-center justify-center text-white">
            <Globe className="mx-2 animate-spin" />
            <p className="font-medium tracking-tight mr-3">
              {children ? children : "Get Started"}
            </p>
          </div>
          <div className="text-[#fff] group-hover:ml-2 ease-in-out transition-all size-[26px] flex items-center justify-center rounded-full border-2 border-[#3b3a3a]">
            <ArrowRight
              size={18}
              className="group-hover:rotate-45 ease-in-out transition-all"
            />
